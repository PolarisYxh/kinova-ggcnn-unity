...
class DepthImage(Image):
    ...
    def inpaint(self, missing_value=0):
        ...
        self.img = cv2.copyMakeBorder(self.img, 1, 1, 1, 1, cv2.BORDER_DEFAULT)#图片size四周都加1，值为镜面反射
        ...
        self.img = cv2.inpaint(self.img, mask, 1, cv2.INPAINT_NS) #给mask的点按邻域1个点来修复
