...
class yxhDataset(GraspDatasetBase):
    ...
    def _get_crop_attrs(self, idx):
        gtbbs = grasp.GraspRectangles.load_from_yxh_file(self.grasp_files[idx])
        center = gtbbs.center
